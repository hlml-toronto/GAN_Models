...
# Spatial size of training data.
num_points = 400 # Allows for 8 modes with 50 sampes from each mode, for a multimodal Gaussian

# Number of dimensions in the training images. For Cartesian coordaintes this is 2
ndim = 2

# Dimension of z latent space (i.e. dimension of generator input)
